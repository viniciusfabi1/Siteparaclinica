	...
	<!-- Featured -->
		<div id="featured">
			<div class="container">
				...
				<p>O Consultório Médico Santa Mônica tem atendimento em diversas áreas da saúde com o  Funcionamento de segunda a sexta das 08:00 as 22:00 horas.<br>Para marcar sua consulta basta ir em Atendimento Online logo abaixo.</p>
				<hr />
				...
				<div class="row">
					...
					<section class="4u">
						...
						<p>Caso tenha se interessado e queira agendar uma consulta com algum de nossos médicos, dê início ao seu cadastro<a href="./cadastro.php"> aqui</a>.</p>
					</section>
					<section class="4u">
